    ...
    <div className="bg-gray-800 rounded-xl p-6">
      ...
      <div className="bg-gray-900 rounded-lg p-4 mb-4">
        ...
        <div className="flex items-center">
          ...
          />
          <button className="bg-gray-700 px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors">Select Token</button>
        </div>
      </div>

      {/* Swap Button */}
      <button className="bg-gray-700 p-2 rounded-full mx-auto block mb-4 hover:bg-gray-600 transition-colors">↓</button>
